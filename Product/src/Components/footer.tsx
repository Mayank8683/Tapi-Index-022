        ...
        <Container as={Stack} maxW={'8xl'} py={10}>
          <SimpleGrid
            ...
            <Stack spacing={6}>
              ...
              <Text fontSize={'xl'}>
                © 2024 Product School. All rights reserved
              </Text>
              <Stack direction={'row'} spacing={6}>
                <SocialButton label={'Twitter'} href={'https://twitter.com/@productschool'}>
                  <FaTwitter />
                </SocialButton>
                <SocialButton label={'YouTube'} href={'https://www.youtube.com/channel/UC6hlQ0x6kPbAGjYkoz53cvA'}>
                  <FaYoutube />
                </SocialButton>
                <SocialButton label={'Instagram'} href={'https://www.instagram.com/productschool/'}>
                  <FaInstagram />
                </SocialButton>
              </Stack>
            </Stack>
            <Stack align={'flex-start'}>
              ...
              <Link href={'https://productschool.com/about'}>About us</Link>
              <Link href={'https://productschool.com/reviews-testimonials'}>student Reviews</Link>
              <Link href={'https://productschool.com/contact-us/new-instructor'}>Our Instructors</Link>
              <Link href={'https://productschool.com/careers'}>Career</Link>
              <Link href={'https://productschool.com/faq'}>FAQ</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>Support</ListHeader>
              <Link href={'https://productschool.com/contact-us'}>Help Center</Link>
              <Link href={'https://productschool.com/terms'}>Terms of Service</Link>
              <Link href={'https://productschool.com/code-of-conduct'}>Legal</Link>
              <Link href={'https://productschool.com/privacy'}>Privacy Policy</Link>
              <Link href={'https://assets.ctfassets.net/6nwv0fapso8r/5VxfSvpHPOrzSwWm8eBCS9/4ef1dba89dde2ec02c1cae09c47467ce/2024_PS_Course_Catalog.pdf'}>Satus</Link>
            </Stack>
            <Stack align={'flex-start'}>
              ...
              <Stack direction={'row'}>
                ...
                />
                <IconButton
                  bg={useColorModeValue('#103869', '#81d4fa')}
